      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="card-crime p-8 space-y-6 text-foreground">
          ...
          <p>
            ...
            <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-primary underline">Free Privacy Policy Generator</a>.
          </p>
          ...
          <ul className="list-disc list-outside ml-6 space-y-2">
            ...
            <li>
              <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CrimePulse.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to CrimePulse, accessible from{' '}
          ...
          <p>
            ...
            <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" target="_blank" rel="noopener noreferrer" className="text-primary underline">Free Privacy Policy website</a> article.
          </p>
          ...
          <h4 className="font-semibold">Business Transactions</h4>
          <p>
          ...
          <h4 className="font-semibold">Other legal requirements</h4>
          ...
          <ul className="list-disc list-outside ml-6 space-y-2">
            <li>
              <p>
                ...
                <a href="info@crimepulse.lk" rel="external nofollow noopener" target="_blank" className="text-primary underline">info@crimepulse.lk</a>
              </p>
            </li>
            <li>
